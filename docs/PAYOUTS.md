...
`RESOLVE_PAYOUT=1 ./build/bin/open-ethash-pool payouts.json`.
...
Address: 0xd34699FD152fe38CAacD3C096F6abb1cd79e88b2, Amount: 166798415 Shannon, 2016-05-11 08:14:34
```

followed by

```
Credited 166798415 Shannon back to 0xd34699FD152fe38CAacD3C096F6abb1cd79e88b2
```
...
> 1) "0xd34699FD152fe38CAacD3C096F6abb1cd79e88b2:25000000"
...
eth.sendTransaction({
  from: eth.coinbase,
  to: '0xd34699FD152fe38CAacD3C096F6abb1cd79e88b2',
...
```
ZADD "eth:payments:all" 1462920526 0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331:0xd34699FD152fe38CAacD3C096F6abb1cd79e88b2:25000000
```

```
ZADD "eth:payments:0xd34699FD152fe38CAacD3C096F6abb1cd79e88b2" 1462920526 0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331:25000000
```

### Delete Erroneous Payment Entry

```
ZREM "eth:payments:pending" "0xd34699FD152fe38CAacD3C096F6abb1cd79e88b2:25000000"
```
